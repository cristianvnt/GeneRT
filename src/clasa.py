...
class DiseaseGeneApp1:
    def __init__(self, root):
        self.root = root
        # Creează un frame în parent
        frame = tk.Frame(root, bg="lightblue")
        frame.pack(fill="both", expand=True)

        # Orice UI logic aici
        label = tk.Label(frame, text="KEGG Disease Gene Explorer", bg="lightblue", font=("Arial", 14))
        label.pack(pady=20)
